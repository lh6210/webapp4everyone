...
if ( isset($_POST['login']) ) {
    $_SESSION['who'] = htmlentities($_POST['email']); // $_SESSION['who'] is recorded, so that user don't have to type email again
	...
	exit;
	    ...
	    error_log("Login success ".$_SESSION['who']);
            header('Location: index.php'); // go to index.php with valid $_SESSION['who']
            exit;
        } else {
